...
export default function Myths() {
  ...
  return (
    <section className="py-20 lg:py-28 bg-[#1b2d4f]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {t.myths.items.map((item, i) => (
            <div
              key={i}
              className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8 hover:border-[#c4962e]/30 transition-colors"
            >
              {/* Myth */}
              ...
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-full bg-[#c4962e]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <CheckCircle className="w-4 h-4 text-[#c4962e]" />
                </div>
                <div>
                  <p className="text-xs uppercase tracking-wider text-[#c4962e] font-semibold mb-1">Fact</p>
